...
def main():
    kev_files = input("Enter the paths to the KEV files, separated by commas: ").split(',')
    ...
    for kev_file in kev_files:
        ...
        file_names.append(kev_file)

    if extracted_data_list:
        write_to_html(extracted_data_list, output_file, file_names)
        print(f"Data has been written to {output_file}.")
    else:
        print("No valid KEV files were processed.")
